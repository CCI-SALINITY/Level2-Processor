...
for orb=['D']
    for ii=3:length(dirL2)
        if strcmp(orb,dirL2(ii).name(5))
            ...
            % SSScorrRR : SSS corrigee RR et lat
            ...
            for iplan=1:nplan
                ...
                SSS_corr(:,:,iplan)=SSS_corrplan;   % SSS corrigee du biais relatif, absolu, RR et latitudinal
            end
            
            % estimer correction totale
            % SSS_latSSTcorr : correction RR et lat >0
            % SSS_corr : SSS corrigee du biais relatif, absolu, RR et latitudinal
            % SSSsel : SSS corrigee du biais RR et latitudinal
