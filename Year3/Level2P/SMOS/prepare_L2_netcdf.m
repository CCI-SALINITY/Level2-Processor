...
for ifile=3:nfile
    ...
    load(nametot,'SSS_corr','totalcorrection','chiSSS0','SSS_random','sss_qc_smos','isc_qc','lsc_qc','Rain_Rate0');
    ...
    elseif strcmp(window0,'dail')
        ttt_init=nanmin(nanmin(nanmin(tSSS0)));   % correction year2
        ttt_end=nanmax(nanmax(nanmax(tSSS0)));  % correction year2
    end
